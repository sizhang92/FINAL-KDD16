function DBLPedge = importDBLPedge(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   DBLPEDGE = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   DBLPEDGE = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   DBLPedge = importfile('DBLP-edge.txt', 1, 79691);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/08/30 20:42:26
