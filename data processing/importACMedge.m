function ACMedge = importACMedge(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   ACMEDGE = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   ACMEDGE = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   ACMedge = importfile('ACM-edge.txt', 1, 63412);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/08/30 20:38:09
